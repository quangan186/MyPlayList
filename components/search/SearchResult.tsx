...
const SearchResult: React.FC<SearchResultModel> = ({
  ...
  return (
    ...
    >
      <div className="hover:opacity-70 gap-4 flex items-center w-full duration-200" onClick={onClick}>
      ...
      <Button className="hover:opacity-70 duration-200" onClick={onAddClick}>
